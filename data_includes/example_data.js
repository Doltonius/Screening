...
["sep", Separator, { }],
    ...
    ["2C-3W-4G-1", aj, {s: "Which man did Mary make the claim that you saw?"}],
    ["2C-3W-4G-2", aj, {s: "Which man did Mary believe the claim that you saw?"}],
    ["2W-3W-4G-1", aj, {s: "Which man did Mary wonder whether you saw?"}],
    ["2N-3W-4G-1", aj, {s: "Which man did Mary think that you saw?"}],
    ["2N-3W-4G-2", aj, {s: "Which man did Mary claim that you saw?"}],

    ["2C-3W-4R-1", aj, {s: "Which man did Mary make the claim that you saw him?"}],
    ["2C-3W-4R-2", aj, {s: "Which man did Mary believe the claim that you saw him?"}],
    ["2W-3W-4G-1", aj, {s: "Which man did Mary wonder whether you saw him?"}],
    ["2N-3W-4G-1", aj, {s: "Which man did Mary think that you saw him?"}],
    ["2N-3W-4G-2", aj, {s: "Which man did Mary claim that you saw him?"}],

    ["1A-2N-1", aj, {s: "The boy[i] likes himself[i]."}],
    ["1A-2N-2", aj, {s: "The boy[i]'s mother likes himself[i]."}],

    ["1V-2N-1", aj, {s: "Every boy{i} likes his{i} mother."}],
    ["1V-2N-2", aj, {s: "His mother{i} likes every boy{i}."}],

    ["1C-2N-1", aj, {s: "John[i] thinks that Mary likes him[1]."}],
    ["1C-2N-2", aj, {s: "He[i] thinks that Mary likes John[i]."}]
